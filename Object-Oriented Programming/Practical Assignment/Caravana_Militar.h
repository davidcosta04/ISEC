...
#ifndef TRABALHOPRATICO_CARAVANA_MILITAR_H
#define TRABALHOPRATICO_CARAVANA_MILITAR_H
...
public:
    Militar()= default;
    Militar(const int &x, const int &y, const char &simbolo);
    Militar(const Militar &m);
    Militar* clone(const int &x, const int &y, const char simbolo) const override;
...
#endif //TRABALHOPRATICO_CARAVANA_MILITAR_H
